    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/appointments", "/api/v1/appointments/**")
                    .hasAnyRole("MEDICO", "ENFERMEIRO")
                .requestMatchers(HttpMethod.PUT, "/api/v1/appointments", "/api/v1/appointments/**")
                    .hasAnyRole("MEDICO", "ENFERMEIRO")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/appointments", "/api/v1/appointments/**")
                    .hasAnyRole("MEDICO", "ENFERMEIRO")
